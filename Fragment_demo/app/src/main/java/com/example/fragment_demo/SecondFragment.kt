...
class SecondFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val textView = view.findViewById<TextView>(R.id.tvF2)

        val args : String? = arguments?.getString("textFromFirstFrag")

        Log.d("TAG", "Hello from SecondFrag, data = $args")
